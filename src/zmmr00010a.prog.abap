...
"   inputs: pt_table (standard table), changes pt_fieldcat
*----------------------------------------------------------------------
...
*----------------------------------------------------------------------
" build_fcat_0100 — adjust per-field attributes via CASE FIELDNAME
"   output: gt_fcat (global)
*----------------------------------------------------------------------
...
*----------------------------------------------------------------------
" display_alv_0100 — creates Docking Container + ALV Grid, displays data
"   reads: gt_data, gt_fcat (globals)
*----------------------------------------------------------------------
